...
export default function ManageInventoryPage() {
  ...
  let [newProductType, setNewProductType] = useState<ProductType>(ProductType.ICECREAM);
            ...
            <div className="centerFormat">
                ...
                <TextField 
                  ...
                  <FormControl>
                    ...
                    >
                      <FormControlLabel value="flavor" control={<Radio />} label="Flavor" onChange={(event)=> {setNewProductType(ProductType.ICECREAM)}}/>
                      <FormControlLabel value="topping" control={<Radio />} label="Topping" onChange={(event)=> {setNewProductType(ProductType.TOPPING)}}/>
                      <FormControlLabel value="cone" control={<Radio />} label="Cone" onChange={(event)=> {setNewProductType(ProductType.CONE)}}/>
                    </RadioGroup>
                  </FormControl>
                  <Button
                  onClick={(event)=> {
